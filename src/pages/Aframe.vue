<template>
  <q-page class="container scene">
    <a-scene arjs='debugUIEnabled: false;'>
      <a-marker id='frac3' type='pattern' url='statics/marker/1.patt' vidhandler>
         <a-plane src="statics/caixa/1.jpeg" scale="6.3 6.3 6.3" rotation="-90 90 0" position="0 0 -0.8" transparent="true">
          </a-plane>
      </a-marker>
      <a-marker id='frac3' type='pattern' url='statics/marker/2.patt' vidhandler>
      ...
      <a-marker id='frac3' type='pattern' url='statics/marker/13.patt' vidhandler>
         <a-plane src="statics/caixa/13.jpeg" scale="6.3 6.3 6.3" rotation="-90 90 0" position="0 0 -0.8" transparent="true">
          </a-plane>
      </a-marker>
      <a-marker id='frac3' type='pattern' url='statics/marker/14.patt' vidhandler>
         <a-plane src="statics/caixa/14.jpeg" scale="6.3 6.3 6.3" rotation="-90 90 0" position="0 0 -0.8" transparent="true">
          </a-plane>
      </a-marker>
